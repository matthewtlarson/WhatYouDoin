      ...
      >
        ...
        <Collapse in={open}>
          <div id="example-collapse-text">
            <form style={{ width: "100%", backgroundColor: "#979dac" }} onSubmit={handleFormSubmit}>
              <div
                className="form-group border border-primary p-3 mb-2 text-dark text-center collpase"
